package com.social.marketing.search.antlr4;// Generated from Query.g4 by ANTLR 4.13.2
...
public class QueryParser extends Parser {
    public static final int
            OP = 1, ONE_VALUE_FUNC = 2, NO_VALUE_FUNC = 3, MULTIPLE_VALUE_OP = 4, BOOL = 5,
            STRING = 6, AND = 7, OR = 8, NUMBER = 9, LPAREN = 10, RPAREN = 11, EQ = 12, NE = 13, GT = 14,
            GE = 15, LT = 16, LE = 17, CONTAINS = 18, CONTAINS_IGNORE_CASE = 19, STARTS_WITH = 20,
            STARTS_WITH_IGNORE_CASE = 21, ENDS_WITH = 22, ENDS_WITH_IGNORE_CASE = 23, NULL = 24,
            NOT_NULL = 25, EMPTY = 26, NOT_EMPTY = 27, IN = 28, NIN = 29, COMMA = 30, IDENTIFIER = 31,
            LineTerminator = 32, WS = 33;
    public static final int
    ...
    private static String[] makeRuleNames() {
        return new String[]{
                "input", "query", "criteria", "key", "value"
        };
    }

    private static String[] makeLiteralNames() {
        return new String[]{
                null, null, null, null, null, null, null, "'and'", "'or'", null, "'('",
                "')'", "' eq '", "' ne '", "' gt '", "' ge '", "' lt '", "' le '", "'contains'",
                "'containsIgnoreCase'", "'startsWith'", "'startsWithIgnoreCase'", "'endsWith'",
                "'endsWithIgnoreCase'", "'null'", "'notNull'", "'empty'", "'notEmpty'",
                "' in '", "' nin '", "','"
        };
    }
    ...
    private static String[] makeSymbolicNames() {
        return new String[]{
                null, "OP", "ONE_VALUE_FUNC", "NO_VALUE_FUNC", "MULTIPLE_VALUE_OP", "BOOL",
                "STRING", "AND", "OR", "NUMBER", "LPAREN", "RPAREN", "EQ", "NE", "GT",
                "GE", "LT", "LE", "CONTAINS", "CONTAINS_IGNORE_CASE", "STARTS_WITH",
                "STARTS_WITH_IGNORE_CASE", "ENDS_WITH", "ENDS_WITH_IGNORE_CASE", "NULL",
                "NOT_NULL", "EMPTY", "NOT_EMPTY", "IN", "NIN", "COMMA", "IDENTIFIER",
                "LineTerminator", "WS"
        };
    }
    ...
    public final ValueContext value() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                setState(62);
                _la = _input.LA(1);
                if (!((((_la) & ~0x3f) == 0 && ((1L << _la) & 2147484256L) != 0))) {
    ...
    public static class AtomQueryContext extends QueryContext {
        public AtomQueryContext(QueryContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class PriorityQueryContext extends QueryContext {
        public PriorityQueryContext(QueryContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class OpQueryContext extends QueryContext {
        ...
        public OpQueryContext(QueryContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class CriteriaContext extends ParserRuleContext {
        ...
        public TerminalNode MULTIPLE_VALUE_OP() {
            return getToken(QueryParser.MULTIPLE_VALUE_OP, 0);
        }
        ...
        public TerminalNode NO_VALUE_FUNC() {
            return getToken(QueryParser.NO_VALUE_FUNC, 0);
        }

        public TerminalNode ONE_VALUE_FUNC() {
            return getToken(QueryParser.ONE_VALUE_FUNC, 0);
        }
    ...
    public static class KeyContext extends ParserRuleContext {
        ...
        public TerminalNode IDENTIFIER() {
            return getToken(QueryParser.IDENTIFIER, 0);
        }
    ...
    public static class ValueContext extends ParserRuleContext {
        ...
        public TerminalNode BOOL() {
            return getToken(QueryParser.BOOL, 0);
        }
